...
class ViewQuizListByCategory(ListView):
    ...
    def get_context_data(self):
        context = super(ViewQuizListByCategory, self).get_context_data()
...
class QuizUserProgressView(TemplateView):
    ...
    def get_context_data(self):
        context = super(QuizUserProgressView, self).get_context_data()
...
class QuizTake(FormView):
    ...
    def get_context_data(self):
        context = super(QuizTake, self).get_context_data()
